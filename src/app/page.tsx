  ...
  content: {
    fr: {
      ...
      persuasion: {
        ...
        title: "Vos reportings hebdo coutent plus cher que ce qu'ils rapportent.",
        paragraphs: [
          { type: "pathos", text: "Vendredi 16h45. Votre Chief of Staff est encore dans Excel pour fusionner les exports Salesforce, Stripe, Mixpanel et Notion en une slide deck propre pour le comite de lundi. Elle a passe 4 heures cette semaine sur la consolidation, et 90 minutes sur le storytelling — qui ne sera pas lu. Le CEO survolera, posera une question sur un chiffre qu'elle a oublie de croiser, et lundi soir elle relancera le cycle pour la 47eme semaine consecutive. Pendant ce temps, le vrai signal — un decrochage MQL en region DACH — passe inapercu jusqu'au mois suivant." },
          { type: "logos", text: "PwC a mesure en 2025 que les equipes ops/finance des scale-ups B2B passent en moyenne 14h par semaine en assemblage de rapports manuels, dont 67% sont obsoletes le jour ou ils sont lus. Gartner indique que les entreprises avec reporting automatise prennent leurs decisions financieres 2.7x plus vite et detectent les anomalies 4 jours plus tot. McKinsey estime le ROI d'un reporting automatise a 18x sur 24 mois." },
          { type: "ethos", text: "Wikolabs construit des agents IA en production depuis 2023 pour des scale-ups B2B, family offices et fintechs reglementees. Nous avons brule nos doigts sur les memes problemes que vous : pipelines qui hallucinent, briefs ignores, dashboards desertes. Reportly est ce que nous avons construit pour nos propres clients exigeants avant de le proposer au marche." },
          { type: "solution", text: "Concretement : Reportly se branche sur votre CRM, ERP, Stripe, GA et HubSpot en quelques clics, ingere les donnees, applique le template de votre choix (board, equipe, investisseurs), et chaque lundi a 8h le rapport est dans la boite mail ou le Slack des bons destinataires — avec narrative IA et alertes sur les KPIs hors de la zone verte. Resultat : 12h economisees par semaine, zero rapport oublie, et un pilotage hebdomadaire enfin reel." },
        ],
      },
      ctaTitle: "Votre prochain reporting hebdo s'envoie sans vous",
      ctaDesc: "Connexion des sources en 30 minutes. Premier rapport livre lundi prochain. Aucune carte bancaire.",
      ctaPrimary: "Reserver un appel",
      ctaWhatsApp: "WhatsApp",
      ctaDemo: "Demander une demo",
      ctaSoonBadge: "Bientot",
      footerTagline: "Reporting business automatise pour scale-ups",
    },
    en: {
      langLabel: "EN",
      tagLabel: "Automated reporting · KPIs · Multi-channel",
      taglines: ["Your data gathered.", "Your report writes itself.", "Every Monday at 8am."],
      taglineAccentIdx: 1,
      desc: "Reportly connects all your data sources, generates personalized business reports and delivers them to your team — by email, Slack or PDF — on the cadence you choose.",
      navLinks: [
      ...
      metrics: [
        { value: "30+", label: "templates included" },
        { value: "12h", label: "saved / week" },
        { value: "0", label: "report forgotten" },
        { value: "100%", label: "automated" },
      ],
      features: [
        { icon: "📊", title: "Smart templates", desc: "Choose from 30+ templates or build your own. Reportly adapts layout and detail level to the audience: executives, teams or investors." },
        { icon: "📡", title: "Native multi-channel", desc: "Email, Slack, PDF, Notion, Google Drive — your report arrives where your team works, automatically, on your weekly or monthly cadence." },
        { icon: "🔔", title: "Threshold alerts", desc: "Set critical thresholds on your KPIs. Reportly fires an immediate alert if a metric leaves the green zone, without waiting for the next report." },
      ],
      steps: [
        { num: "01", title: "Connect your sources", desc: "CRM, ERP, Google Analytics, Stripe, HubSpot — Reportly centralizes all your data in a few clicks. No code, no ETL to configure." },
        { num: "02", title: "Configure your report", desc: "Choose metrics, period, template and recipients. The AI adapts the narrative and surfaces the meaningful trends." },
        { num: "03", title: "The report sends itself", desc: "Every Monday at 8am (or on your cadence), the report is generated, verified and delivered. Your team reads, you decide." },
      ],
      persuasion: {
        sectionTag: "Why now",
        title: "Your weekly reports cost more than they pay back.",
        paragraphs: [
          { type: "pathos", text: "Friday 4:45pm. Your Chief of Staff is still in Excel merging Salesforce, Stripe, Mixpanel and Notion exports into a clean deck for Monday's committee. She spent 4 hours this week on consolidation, and 90 minutes on storytelling — which won't be read. The CEO will skim, ask about a number she forgot to cross-reference, and Monday night she'll restart the cycle for the 47th consecutive week. Meanwhile, the real signal — an MQL drop in DACH — will go unnoticed until next month." },
          { type: "logos", text: "PwC measured in 2025 that ops/finance teams at B2B scale-ups spend on average 14h per week assembling manual reports, of which 67% are stale the day they're read. Gartner indicates that companies with automated reporting make financial decisions 2.7x faster and detect anomalies 4 days earlier. McKinsey estimates the ROI of automated reporting at 18x over 24 months." },
          { type: "ethos", text: "Wikolabs has been building production AI agents since 2023 for B2B scale-ups, family offices and regulated fintechs. We burned our fingers on the same problems you face: hallucinating pipelines, ignored briefs, abandoned dashboards. Reportly is what we built for our own demanding customers before bringing it to market." },
          { type: "solution", text: "Concretely: Reportly plugs into your CRM, ERP, Stripe, GA and HubSpot in a few clicks, ingests the data, applies the template of your choice (board, team, investors), and every Monday at 8am the report is in the right inboxes or Slack channels — with AI narrative and alerts on KPIs outside the green zone. Result: 12h saved per week, zero forgotten report, and weekly steering finally real." },
        ],
      },
      ctaTitle: "Your next weekly report sends itself",
      ctaDesc: "Source connection in 30 minutes. First report delivered next Monday. No credit card.",
      ctaPrimary: "Book a call",
      ctaWhatsApp: "WhatsApp",
      ctaDemo: "Request a demo",
      ctaSoonBadge: "Soon",
      footerTagline: "Automated business reporting for scale-ups",
    },
  },
};
