...
export const metadata: Metadata = { title:"Reportly — Generation automatique de rapports business IA", description:"Reportly genere et livre vos rapports business personnalises chaque semaine, automatiquement, sans manipulation manuelle." };
